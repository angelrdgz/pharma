...
<body class="bg-gray-900 font-sans leading-normal tracking-normal mt-12">
    ...
    <nav class="bg-gray-900 pt-2 md:pt-1 pb-1 px-1 mt-0 h-auto fixed w-full z-20 top-0">
        ...
        <div class="flex flex-wrap items-center">
            <div class="flex flex-shrink md:w-1/3 justify-center md:justify-start text-white">
                <a href="#">
                    <img src="{{ asset('images/logo.png') }}" style="height: 40px; margin-left:30px;"alt="">
                </a>
            </div>
				    ...
				    <li class="flex-1 md:flex-none md:mr-3">
						<div class="relative inline-block">
                            ...
                            <div id="myDropdown" class="dropdownlist absolute bg-gray-900 text-white right-0 mt-3 p-3 overflow-auto z-30 invisible">
                                ...
                                <a class="p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block" href="{{ url('logout') }}" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();">
                                    Salir
                                </a>    
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="bg-gray-900 shadow-lg h-16 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-56">
            ...
            <div class="md:mt-12 md:w-56 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                    <li class="mr-3 flex-1">
                        <a href="{{ url('insumos') }}" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500">
                            <i class="fas fa-tasks pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Insumos</span>
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
                        <a href="{{ url('productos') }}" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500">
                            <i class="fas fa-tasks pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Productos</span>
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
                        <a href="{{ url('productos') }}" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500">
                            <i class="fas fa-tasks pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Ordenes de Compra</span>
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
                        <a href="{{ url('usuarios') }}" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500">
  ...
  <script src="{{ url('js/jquery_3.4.1.js') }}"></script>
    <script>
