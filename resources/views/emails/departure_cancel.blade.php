...
<p style="font-size: 28px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 28px;"><strong><span style="font-size: 28px;">Orden de Fabricación Cancelada</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">El empleado <b>{{ $user_name }}</b> há cancelado la orden de fabricación con el número <b>{{ $order_number }}</b.></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
